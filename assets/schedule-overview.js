(() => {
  ...
  const courses = [
    {
      key: 'politics', type: '班课', name: '公共政治经济', teacher: '刘淼', mode: '网课', room: '无需教室',
      meta: '周日 14:00–17:00',
      events: [
    ...
    {
      key: 'japanese', type: '班课', name: '国语', teacher: '刘淼', mode: '线下', room: '待分配',
      meta: '9/4暂定线上｜10/9起周五 13:40–16:40',
      events: [
        ...
        ['2026-10-09',3,0],['2026-10-16',3,0],['2026-10-23',3,0],['2026-10-30',3,0]
      ]
    },
    { key: 'english', type: '班课', name: '共通英语阅读', teacher: '刘淼', mode: '网课', room: '无需教室', meta: '授课时间未定', events: null },
    {
    ...
    },
    {
      ...
      meta: '9/6 09:00–12:00｜9/13起周日 18:00–21:00｜讲义・刷题一体',
    ...
    {
      key: 'commonPhysics', type: '班课', name: '物理共通考试冲刺课程', teacher: '刘可惟／金龙熙',
      mode: '线下', room: '待分配',
    ...
    { key: 'privatePhysics', type: '一对一', name: '魏思远物理一对一', teacher: '刘可惟', mode: '线下', room: '待分配', meta: '8/30 15:00–17:00｜后续待定', events: [['2026-08-30',2,0]] }
  ];
