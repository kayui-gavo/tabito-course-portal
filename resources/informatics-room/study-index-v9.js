...
(() => {
  ...
  if(page==='index.html'||page===''){
    ...
    if(lead)lead.textContent='教材の9講・47PARTを原教材と逐項照合し、本文・細部ノート・教材型演習に加えて、2進法、画像・音声、圧縮、論理回路、2の補数、記憶装置、セキュリティ、通信、メール、データベース、尺度・統計・回帰などは画面上で操作しながら学べます。';
    insertStrip(document.querySelector('.study-guide:not(.programming-guide)'),[
      ['47','PARTを逐項照合','定義・側注・数値例まで本文へ戻す'],
      ['24','インタラクティブ実験','計算・分類・通信・論理・統計をその場で操作'],
