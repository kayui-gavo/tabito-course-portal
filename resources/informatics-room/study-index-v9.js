...
(() => {
  ...
  if(page==='index.html'||page===''){
    ...
    if(lead)lead.textContent='教材の9講・47PARTを原教材と逐項照合。本文・細部ノート・教材型演習に加え、デジタル表現、情報デザイン、ハードウェア、プログラミング、モデル化、ネットワーク、情報システム、データ分析など、図そのものが理解の中心になる項目は専用の高精細図版へ作り直し、その直後に考える問い・操作型演習を接続しています。';
    insertStrip(document.querySelector('.study-guide:not(.programming-guide)'),[
      ['47','PARTを逐項照合','定義・側注・数値例まで本文へ戻す'],
      ['40','本編の専用高精細図版','関係・方向・数値例を教材に合わせて描き直す'],
