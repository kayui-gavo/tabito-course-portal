...
(() => {
  ...
  if(page==='programming.html'){
    ...
    if(lead)lead.textContent='初級14講・中級19講・上級15講を教材順で進めます。print・演算・配列・range・分岐・whileといった初級から、関数、2次元配列、入れ子、ソート、料金計算、統計、グラフ理論、待ち行列、誤り検出、すごろくまで全48講に専用図版を用意しました。図だけで終わらず、23講では図直結の追跡インタラクティブを置き、全講で実際のPythonもブラウザ上で実行できます。';
