// v19 production matrix: 5 hub pages + 95 lessons, desktop and mobile = 200 cases.
  ...
  try{
    ...
    const state=await page.evaluate(()=>{
      ...
      if(pageName==='questions.html'||pageName==='exam.html'){
        const details={latestPractice,ch12:window.SOURCE_PRACTICE_CH1_2_FIDELITY_V14===true,ch3:window.SOURCE_PRACTICE_CH3_FIDELITY_V15===true,ch4:window.SOURCE_PRACTICE_CH4_FIDELITY_V16===true,ch5:window.SOURCE_PRACTICE_CH5_FIDELITY_V17===true};
        hubSemantic={name:'practice-source',details,ok:details.latestPractice&&details.ch12&&details.ch3&&details.ch4&&details.ch5};
      }
      return {id,overflow:Math.max(0,Math.round(width-innerWidth)),canvas:(window.INFORMATION_CANVAS_TEXT_AUDIT_V13||{})[id]||null,layout:window.INFORMATION_LAYOUT_AUDIT_V13||null,pageAudit:window.INFORMATION_PAGE_AUDIT_V13||null,figures:document.querySelectorAll('.scientific-figure-v12').length,oldFigures:document.querySelectorAll('.scientific-figure-v11').length,duplicateNav:document.querySelectorAll('.lesson-nav-v13').length,visibleOldProgress:[...document.querySelectorAll('.lesson-reading-progress')].filter(n=>getComputedStyle(n).display!=='none').length,ch12PracticeFidelity:window.SOURCE_PRACTICE_CH1_2_FIDELITY_V14===true,ch3PracticeFidelity:window.SOURCE_PRACTICE_CH3_FIDELITY_V15===true,ch4PracticeFidelity:window.SOURCE_PRACTICE_CH4_FIDELITY_V16===true,ch5PracticeFidelity:window.SOURCE_PRACTICE_CH5_FIDELITY_V17===true,hubSemantic};
    });
    ...
    if(url.includes('lesson.html')){
      ...
      if(/^b4-/.test(state.id)&&!state.ch4PracticeFidelity)problems.push('chapter 4 source-practice fidelity overlay missing');
      if(/^b5-/.test(state.id)&&!state.ch5PracticeFidelity)problems.push('chapter 5 source-practice fidelity overlay missing');
